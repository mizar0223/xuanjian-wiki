...
>
> 最近更新：2026-05-10 23:00（合并自旧 `交接提示.md` + `wide_window/workflow.md` + `rescue3-plan.md` 精华）
...
| 优先级 | 问题 | 量级 |
|---|---|---|
| P1 | B15 脚本批次功能机械复读 | ~12 页 |
| P2 | L6（仅 1 次提及）维持机械底版 | 155 页 |
| P2 | 跨命名空间消歧 | 7 个（凌云木/坎水/并火/牝水/真火/离火/镂金石） |
| P3 | 内链补全（造物→人物→道统→家族） | 全量 |
| P3 | 专题页未启动 | 5-10 个高价值（太阴道/李家世系/仙鉴/月华元府等） |
