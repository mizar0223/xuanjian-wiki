...
ROOT = Path("/Users/leoshi/AIBOOK/xuanjian/wiki/资料库-法宝:道具:灵资/pages")
...
def main():
    ...
    # 输出详细报告到文件
    report_path = Path("/Users/leoshi/AIBOOK/xuanjian/wiki/资料库-法宝:道具:灵资/.workbuddy/red_links_report.md")
