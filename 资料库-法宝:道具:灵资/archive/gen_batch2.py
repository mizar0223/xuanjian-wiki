...
OUTPUT_DIR = '/Users/leoshi/AIBOOK/xuanjian/wiki/资料库-法宝:道具:灵资/.workbuddy/output_wiki_batch2'
...
def main():
    ...
    with open('/Users/leoshi/AIBOOK/xuanjian/wiki/资料库-法宝:道具:灵资/玄鉴仙族_法宝考据_批次2_中频实体.md', 'r') as f:
        content = f.read()
