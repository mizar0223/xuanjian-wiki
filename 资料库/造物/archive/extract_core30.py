...
def main():
    batch_files = sorted(glob.glob('/data/workspace/rq0rlzeg/xuanjian-wiki/资料库/造物/玄鉴仙族_法宝考据_批次*.md'))
    ...
    out_path = '/data/workspace/rq0rlzeg/xuanjian-wiki/资料库/造物/.workbuddy/phase0_core30_raw.json'
